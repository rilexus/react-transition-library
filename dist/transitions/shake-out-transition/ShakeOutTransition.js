...
exports.ShakeOutTransition = void 0;
...
const ShakeOutTransition = (0, react_1.forwardRef)(({ children, from, to, timeout, ease = ease_1.Ease.ease, delay = 0, ...props }, outsideRef) => {
    ...
    return ((0, jsx_runtime_1.jsx)(transition_1.Transition, { ...props, ref: outsideRef, timeout: timeout, defaultStyle: defaultStyle, transitionStyle: transitionStyle, className: "ShakeOutTransition", children: children }, void 0));
});
exports.ShakeOutTransition = ShakeOutTransition;
