...
var BackDropTransition = function (_a) {
    ...
    var defaultStyle = useCSSStyle(__assign({ willChange: "backdrop-filter", transition: "backdrop-filter ".concat(timeout, "ms ").concat(ease, " ").concat(delay, "ms, opacity ").concat(timeout, "ms ").concat(ease, " ").concat(delay, "ms") }, style), [timeout, delay]);
    var transitionStyle = useMemo(function () { return ({
        entering: {
            backdropFilter: "blur(".concat(to, "px)"),
            opacity: 1,
        },
        entered: {
            backdropFilter: "blur(".concat(to, "px)"),
        ...
        exiting: {
            backdropFilter: "blur(".concat(from, "px)"),
            opacity: 0,
        },
        exited: {
            backdropFilter: "blur(".concat(from, "px)"),
